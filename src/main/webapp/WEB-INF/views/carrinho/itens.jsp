	        ...
	        <table id="cart-table">
	                ...
	                <c:forEach items="${carrinhoCompras.itens}" var="item">
		                <tr>
		                    ...
		                    <td class="quantity-input-cell">
		                        <input type="number" min="0" readonly="readonly" id="quantidade" name="quantidade" value="${carrinhoCompras.getQuantidadeByCarrinhoItem(item)}" />
		                    </td>
	            ...
	            <tfoot>
	                <tr>
	                    ...
	                    <td class="numeric-cell">${carrinhoCompras.precoTotal}</td>
	                    <td></td>
	                </tr>
	            </tfoot>
	        </table>
